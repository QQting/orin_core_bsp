...
i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x03 0xE0 0x08 # fsync generation is off; manual fsync

sleep 0.5

# i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x03 0x06 0x83 # GPIO2(MFP2): 1M; GPIO_RX_DIS; GPIO_TX_EN & GPIO_OUT_DIS
...
#   err += tier4_max9296_write_reg(dev, gpio_mfp_base, 0x03);       // 0x2B0
#   err += tier4_max9296_write_reg(dev, gpio_mfp_base + 1, 0x06);   // 0x2B1
#   err += tier4_max9296_write_reg(dev, gpio_mfp_base + 2, 0x00);   // 0x2B2
i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x02 0xB0 0x83 # GPIO0(MFP0): 1M; GPIO_RX_DIS; GPIO_TX_EN & GPIO_OUT_DIS
# i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x02 0xB1 0x07 # GPIO0(MFP0): GPIO_TX_ID=0x07
i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x02 0xB1 0xA7 # GPIO0(MFP0): pulldown & push-pull; GPIO_TX_ID=0x07
i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x02 0xB2 0x07 # GPIO0(MFP0): GPIO_RX_ID=0x07
...
# LINKA
echo "[sync]: link-a"
#   err += tier4_max9295_write_reg(dev, MAX9295_GPIO_3_CONFIG_MFP3_ADDR, 0x04); // 0x2C7: 40k; GPIO_RX_EN; GPIO_TX_DIS; GPIO_OUT_EN
#   err += tier4_max9295_write_reg(dev, MAX9295_GPIO_3_GPIO_TX_ID_ADDR, 0x00); // 0x2C8
#   err += tier4_max9295_write_reg(dev, MAX9295_GPIO_3_GPIO_RX_ID_ADDR, 0x06); // 0x2C9
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD3 0x85 # 1M; GPIO7(MFP7): GPIO_RX_EN; GPIO_TX_DIS; GPIO_OUT_DIS
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD6 0x85 # 1M; GPIO8(MFP8): GPIO_RX_EN; GPIO_TX_DIS; GPIO_OUT_DIS
sleep 0.5
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD3 0x84 # 1M; GPIO_RX_EN; GPIO_TX_DIS; GPIO_OUT_EN
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD5 0x07 # GPIO_RX_ID=0x07
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD6 0x84 # 1M; GPIO_RX_EN; GPIO_TX_DIS; GPIO_OUT_EN
i2ctransfer -f -y $I2C_SWITCH w3@$SER_A_7B 0x02 0xD8 0x07 # GPIO_RX_ID=0x07

# LINKB
echo "[sync]: link-b"
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD3 0x85
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD6 0x85
sleep 0.5
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD3 0x84
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD5 0x07
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD6 0x84
i2ctransfer -f -y $I2C_SWITCH w3@$SER_B_7B 0x02 0xD8 0x07
