...
# Replicate MAX96712 Port A data to Port B
 i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x08 0xA9 0xC8  # Copy PHY1 to PHY2 (Port A to Port B)
 sleep 0.5
...
#i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x09 0x4A 0xC0  # default 4 data lane cnt for PHY 1
     ...
     i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x04 0x15 0x2C
     i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x04 0x18 0x2C
     i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x04 0x1B 0x2C
     i2ctransfer -f -y $I2C_SWITCH w3@$DESER_ADDR 0x04 0x1E 0x2C
